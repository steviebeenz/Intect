...
@CheckInfo(name = "Killaura", type = "J", description = "Checks for double hits", maxVL = 20)
public class KillauraTypeJ extends Check {

    public KillauraTypeJ(PlayerStorage data) {
        super(data);
    }
