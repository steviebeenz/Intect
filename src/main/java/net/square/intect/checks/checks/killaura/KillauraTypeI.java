...
@CheckInfo(name = "Killaura", type = "I", description = "Checks for re-sprint delta", maxVL = 20)
public class KillauraTypeI extends Check {

    public KillauraTypeI(PlayerStorage data) {
        super(data);
    }
