...
@CheckInfo(name = "Killaura", type = "S", description = "Checks for invalid rotations", maxVL = 20)
public class KillauraTypeS extends Check {

    public KillauraTypeS(PlayerStorage data) {
        super(data);
    }
