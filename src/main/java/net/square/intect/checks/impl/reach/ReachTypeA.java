package net.square.intect.checks.impl.reach;
...
public class ReachTypeA extends Check
{
    ...
    public void handle(IntectPacket packet)
    {
        ...
        else if (packet.getRawPacket() instanceof WrappedPacketInFlying)
        {
            ...
            WrappedPacketInFlying packetPlayInFlying = (WrappedPacketInFlying) packet.getRawPacket();
    ...
    private void checkDistance(Player player, CraftEntity entity)
    {
        ...
        {
            hitboxPoints -= hitboxPoints > 0 ? 1 : 0;
        }
