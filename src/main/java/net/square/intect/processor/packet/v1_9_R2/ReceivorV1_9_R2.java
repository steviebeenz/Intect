package net.square.intect.processor.packet.v1_9_R2;
...
public class ReceivorV1_9_R2 implements PacketReceivor
{
    ...
    public ReceivorV1_9_R2(Intect intect)
    {
        this.intect = intect;
    }
    ...
    public void readPacket(@SuppressWarnings("rawtypes") Packet packet, Player player)
    {
        ...
        else if (packet instanceof PacketPlayInArmAnimation)
        {
            ...
            {
                check.handle(
                    new IntectPacket(IntectPacket.Direction.RECEIVE, new WrappedPacketInArmAnimation(), player));
            }
        }
    }
